...
var _initSlider = require("./modules/swiper/init-slider");
// ---------------------------------
...
window.addEventListener('DOMContentLoaded', function () {
  ...
  window.addEventListener('load', function () {
    ...
    (0, _initSlider.initCoachesSwiper)();
    (0, _initSlider.initReviewsSwiper)();
...
},{"./modules/form-validate/form":3,"./modules/modals/init-modals":9,"./modules/swiper/init-slider":11,"./modules/tabs/init-tabs":12,"./utils/ios-vh-fix":16}],2:[function(require,module,exports){
"use strict";
...
var initCoachesSwiper = function initCoachesSwiper() {
  var coachSwiper = new _swiper.default('#coaches-slider', {
  ...
  coachSwiper.slides.forEach(function (slide) {
    slide.tabIndex = -1;
  });
  for (var i = coachSwiper.activeIndex; i < coachSwiper.activeIndex + coachSwiper.params.slidesPerView; i++) {
    coachSwiper.slides[i].tabIndex = 0;
  }
  coachSwiper.on('slideChange', function (swiper) {
    swiper.slides.forEach(function (slide) {
      slide.tabIndex = -1;
    });
    for (var _i = swiper.activeIndex; _i < swiper.activeIndex + swiper.params.slidesPerView; _i++) {
      swiper.slides[_i].tabIndex = 0;
    }
  });
};
